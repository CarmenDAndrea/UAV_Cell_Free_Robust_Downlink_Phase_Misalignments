function rho = functionCentralizedPowerAllocation(K, gainOverNoisedB, D, rho_tot, wk, upsilon, kappa, theta)
...
for k = 1:K
    ...
    %MF
        ...
        poww(k) =  sum(gainOverNoise(servingAPs,k).^theta).^upsilon; % theta comes from reference [2]
...
% [2] S. Chen, J. Zhang, E. Björnson, Ö. T. Demir and B. Ai, "Energy-
% Efficient Cell-Free Massive MIMO Through Sparse Large-Scale Fading
% Processing," in IEEE Transactions on Wireless Communications, vol.
% 22, no. 12, pp. 9374-9389, Dec. 2023, doi: 10.1109/TWC.2023.3270299.
